...
} elseif (!checkPhpVersion('7.3.0')) {
    $errorInfo = 'PHP版本不能小于7.3.0';
...
function install($username, $password, $config, $adminUrl)
{
    ...
    $sqlArray = parseSql($sqlPath, $config['prefix'], 'cd_');
    Db::startTrans();
    try {
...
<h2>安装CODE_TG_BOT系统</h2>
<div class="content">
    <p class="desc">
        使用过程中遇到任何问题可参考
        <a href="https://t.me/CODE_TG_BOT">TG交流群</a>
    </p>
    <form class="layui-form layui-form-pane" action="">
        ...
        <div class="bg">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input class="layui-input" name="database" autocomplete="off" lay-verify="required" lay-reqtext="请输入数据库名称" placeholder="请输入数据库名称" value="cd_bot">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input class="layui-input" name="prefix" autocomplete="off" lay-verify="required" lay-reqtext="请输入数据表前缀" placeholder="请输入数据表前缀" value="cd_">
                </div>
            </div>
